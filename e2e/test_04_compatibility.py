...
class TestCompatibility:
    ...
    def test_history_button_opens_sheet(self, at_home):
        screens = at_home
    ...
    def test_analyze_with_preset_partner_runs(self, at_home):
        screens = at_home
    ...
    def test_compat_result_shows_score(self, at_home):
        screens = at_home
    ...
    def test_mangal_dosha_row_opens_sheet(self, at_home):
        screens = at_home
    ...
    def test_kalsarpa_row_opens_sheet(self, at_home):
        screens = at_home
    ...
    def test_ask_destiny_button_opens_dialog(self, at_home):
        screens = at_home
    ...
    def test_navigate_back_to_home(self, at_home):
        screens = at_home
